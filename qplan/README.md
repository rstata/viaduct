...
- [`context-params.md`](./context-params.md) defines model `Assumptions` context parameters, explicit semantics dependencies, and the remaining context-parameter migration boundaries.
