...
object NestedQueryScalarFieldWeight : ConfigKey<Double>(0.0, ::weight)
object QueryScalarFieldWeight : ConfigKey<Double>(0.0, ::weight)
object ObjectOutputFieldWeight : ConfigKey<Double>(0.45, ::weight)
...
object ResolverFragmentSelectionCount : ConfigKey<IntRange>(0..0, ::range)
object ResolverFragmentLongTailWeight : ConfigKey<Double>(0.0, ::weight)
object ResolverFragmentLongTailSelectionCount : ConfigKey<IntRange>(0..0, ::range)
object ResolverFragmentArgumentFieldWeight : ConfigKey<Double>(0.0, ::weight)
