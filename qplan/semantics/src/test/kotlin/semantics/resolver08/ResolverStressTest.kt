...
import semantics.resolver03.registeredResolverApplicationIdentityCounts
import kotlin.test.Test
import kotlin.test.assertEquals
import kotlin.test.assertTrue

/** Opt-in high-volume Resolver08 coverage for deep dependency-heavy generated worlds. */
class ResolverStressTest {
    ...
    fun `deep dependency-heavy arbitrary worlds resolve correctly`(): Unit =
        runBlocking {
            ...
            try {
                ...
                println(
                    "Resolver08 stress: seed=$seed, requestedCases=$requestedCases, " +
    ...
    private fun configured(
        ...
        System.getProperty(property)
            ...
            ?: error("Set $property or $environment; use the :semantics:resolver08Stress task")
    ...
    private companion object {
        ...
        const val STRESS_CASES_ENV = "RESOLVER08_STRESS_CASES"
        const val STRESS_CASES_PROPERTY = "resolver08.stress.cases"
        const val STRESS_SEED_ENV = "RESOLVER08_STRESS_SEED"
        const val STRESS_SEED_PROPERTY = "resolver08.stress.seed"
    }
}
