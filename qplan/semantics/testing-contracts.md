...
- `FrozenObjectResolutionContract` checks that active and passive object occurrences, including nested-list elements, reject new fields after resolution. Resolver01-03, Resolver06-08, and Resolver26 opt into this lifecycle contract.
